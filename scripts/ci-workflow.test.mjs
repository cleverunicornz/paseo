...
const gatedCiJobs = new Map([
  ...
  ["server-tests-ubuntu", { name: "server-tests (linux-x64)", contracts: ["server", "hub"] }],
  ["server-tests-windows", { name: "server-tests (windows-x64)", contracts: ["server", "hub"] }],
  ["desktop-tests-ubuntu", { name: "desktop-tests (linux-x64)", contract: "desktop" }],
  ["desktop-tests-windows", { name: "desktop-tests (windows-x64)", contract: "desktop" }],
